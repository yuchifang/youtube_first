...
const API ='AIzaSyAjBCl8oZwLTtOB5HJBlyxgLCRC1qSCQvw';
...
var finalURL = `https://www.googleapis.com/youtube/v3/search?key=${API}&part=snippet&q=21 poilts&order=relevance&maxResults=${result}`
